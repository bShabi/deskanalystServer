...
router.route('/add').post((req,res) => {
    ...
    const newPlayer= new Player({playerId,teamId,firstName,lastName,timeOnPitch,distance,distanceHalfOne,distanceHalfTwo,progressiveSprints,progressiveSprintsHalfOne,progressiveSprintsHalfTwo,sprints,sprintsHalfOne,sprintsHalfTwo,topSpeed})
